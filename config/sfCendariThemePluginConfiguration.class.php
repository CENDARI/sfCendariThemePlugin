...
class sfCendariThemePluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'CENDARI theme based on Bootstrap 2.0 (and the arDominionPlugin).',
    $version = '0.0.1';
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/sfCendariThemePlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/sfCendariThemePlugin/css/main.css', 'last', array('media' => 'all'));
    }
  }
